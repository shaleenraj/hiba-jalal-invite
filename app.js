...
const translations = {
  en: {
    ...
    pageDescription: 'Hiba & Jalal invite you to celebrate their wedding in Casablanca on 15 August 2026.',
    ...
    venue: 'Dar El Ghalia · Casablanca',
  ...
  ar: {
    ...
    pageDescription: 'تدعوكم هبة وجلال لمشاركتهما فرحة زفافهما في الدار البيضاء يوم ١٥ أغسطس ٢٠٢٦.',
    ...
    venue: 'دار الغالية · الدار البيضاء',
    ...
    cityCountry: 'الدار البيضاء، المغرب',
    ...
    dietaryPlaceholder: 'الحساسيات أو التفضيلات الغذائية',
    note: 'رسالة للعروسين',
  ...
  const videos = [
    {
      ...
      en: 'assets/cover_page_english.mp4',
      ar: 'assets/cover_page_arabic.mp4',
