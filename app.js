...
const translations = {
  en: {
    pageTitle: 'Hiba & Jalal Eddine Wedding',
    pageDescription: 'Hiba & Jalal Eddine invite you to celebrate their wedding in Bouskoura on 15 August 2026.',
    languageLabel: 'Choose language',
    coverSectionLabel: 'Wedding invitation cover',
    coverVideoLabel: "Play Hiba and Jalal Eddine's wedding invitation video",
    itinerarySectionLabel: 'Wedding itinerary',
    itineraryVideoLabel: "Hiba and Jalal Eddine's wedding itinerary",
    ...
    weddingValue: 'Hiba & Jalal Eddine · 15 August 2026',
  },
  ar: {
    pageTitle: 'زفاف هبة وجلال الدين',
    pageDescription: 'تدعوكم هبة وجلال الدين لمشاركتهما فرحة زفافهما في بوسكورة يوم 15 غشت 2026.',
    languageLabel: 'اختيار اللغة',
    coverSectionLabel: 'غلاف دعوة الزفاف',
    coverVideoLabel: 'تشغيل فيديو دعوة زفاف هبة وجلال الدين',
    itinerarySectionLabel: 'برنامج حفل الزفاف',
    itineraryVideoLabel: 'فيديو برنامج زفاف هبة وجلال الدين',
    ...
    weddingValue: 'هبة وجلال الدين · 15 غشت 2026',
  },
};
  ...
  const videos = [
    {
      ...
      ar: 'assets/cover_arabic_6.mp4?v=6',
      enPoster: 'assets/cover-poster.jpg?v=4',
      arPoster: 'assets/cover-poster-ar.jpg?v=6',
    },
    {
      element: document.querySelector('#itineraryVideo'),
      en: 'assets/itenerary_english_6.mp4?v=6',
      ar: 'assets/itinerary_arabic_6.mp4?v=6',
      enPoster: 'assets/itinerary-poster.jpg?v=6',
      arPoster: 'assets/itinerary-poster-ar.jpg?v=6',
    },
  ];
